...
@router.message(Command('refresh_catalog'))
async def refresh_catalog(message: Message):
    if not is_admin(message.from_user):
        return
    db.init_db()
    await message.answer('✅ Каталог обновлён. Все позиции, цены и веса загружены.')
